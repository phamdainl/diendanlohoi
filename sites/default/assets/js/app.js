...
var CODOF = {
    ...
    BBcode2html: function (s) {
        ...
        rep(/\[spoiler=(.*?)\]([^]*?)\[\/spoiler\]/gmi, "<details class='codo_spoiler'><summary>$1</i></summary>$2</details>");
        rep(/\[spoiler\]([^]*?)\[\/spoiler\]/gmi, "<details class='codo_spoiler'><summary>"+codo_defs.trans.spoiler+"</summary>$1</details>");
        ...
        rep(/<p>([^]*?)<\/p>/gmi, function (matchStr, s1) {
                return "<p>" + s1.replace(/\n/gi, "<br />") + "</p>";
            }
        );
