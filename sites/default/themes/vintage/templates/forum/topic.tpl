                ...
                <div id="codo_new_reply" class="codo_new_reply">
                    ...
                    <form id="codo_new_reply_post" action="/" method="POST">
                        ...
                        <div class="codo_new_reply_action">
                            ...
                            <button class="codo_btn codo_btn_def" id="codo_post_attach"><i class="glyphicon glyphicon-upload"></i><span class="codo_action_button_txt">{_t("Upload file")}</span></button>
