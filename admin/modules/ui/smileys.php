...
Class A_Smile {
    ...
    public function get_smilies() {
        ...
        $ret = array();
        $smilesArray = \CODOF\Util::toAssociativeArray($smilies);

        foreach ($smilesArray as $smile) {
    ...
    public function edit_smiley() {
        ...
        $smileyObj = \CODOF\Util::toAssociativeArray($smiley);
        $smileyObj['image_name'] = A_DURI . 'assets/img/smileys/' . $smileyObj['image_name'];
        $this->smarty->assign('smiley', $smileyObj);
    }
