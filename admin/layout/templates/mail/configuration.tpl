    ...
    <div class="box box-info">
        <form class="box-body" action="?page=mail/configuration" role="form" method="post"
            ...
            <select name='smtp_protocol' class="form-control">
                <option value='SSL' {if "smtp_protocol"|get_opt == 'SSL' } selected {/if}>SSL</option>
                <option value='TLS' {if "smtp_protocol"|get_opt == 'TLS' } selected {/if}>TLS</option>
                <option value='none' {if "smtp_protocol"|get_opt == 'none' } selected {/if}>none</option>
            </select><br>
