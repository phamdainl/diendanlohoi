                        ...
                        <aside class="left-side sidebar-offcanvas">
                            ...
                            <section class="sidebar">
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="treeview {$active['reputation/settings']}{$active['reputation/promotions']}{$active['badges/settings']}">
                                        <a href="#">
                                        ...
                                        <ul class="treeview-menu">
                                            <li class="{$active['badges/settings']}"><a href="index.php?page=badges/settings"><i class="fa fa-get-pocket"></i>Badges</a></li>
                                            <li class="{$active['reputation/settings']}"><a href="index.php?page=reputation/settings"><i class="fa fa-wrench"></i>Reputation Settings</a></li>
                                    ...
                                    <li class="{$active['license/index']}">
                                        <a href="index.php?page=license/index">
