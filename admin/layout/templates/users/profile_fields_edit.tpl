        ...
        <div  class="box box-info">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{if isset($field.title)}{$field.title}{/if}" placeholder="if your field does not require a title, you may leave it empty"/>
                </div>
