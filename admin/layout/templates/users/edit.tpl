...
<div class="row" id="add_cat" style="">
    <div class="col-lg-6">
        <div class="box box-info">
            <form class='box-body' action="?page=users/manage&action=edit&user_id={$user.id}" role="form" method="post"
                  enctype="multipart/form-data">
                <input type="hidden" value="edit" name="mode"/>

                <input type="hidden" value="{$user.id}" name="id"/>
                Username:<br>
                <input type="text" name="user_name" value="{$user.username}" class="form-control" placeholder=""
                       required/>
                <br/>
                ...
                <br/>
                Signature:<br>
                <textarea name="signature" placeholder="Forum signature"
                ...
                Confirmed<br/><br/>
                <button onclick="loginAsUser(); return false;" class="btn btn-default">Login as this user</button>
                <br/><br/>
...
<script type="text/javascript">
    ...
    function loginAsUser() {
        window.open("?page=users/manage&action=login_as_user&user_id={$user.id}");
        return false;
    }
