...
--------------------------------------------
    ...
    Statistics :
        {$events.newPosts} {_t("New posts")}
        {$events.newTopics} {_t("New topics")}
...
{$reply.actor.username} {if $reply.mention}{_t("mentioned you in the reply")}{else}{_t("replied you")}{/if} {_t("at")} {$reply.time.hour}:{$reply.time.minute} {$reply.time.meridiem}
