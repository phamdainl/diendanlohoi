                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <table cellpadding="0" border="0" cellspacing="0" style="text-align: center;{$table_style}">
                                        <tr><td style="font-size: 32px;font-weight: bold;padding-bottom: 8px;padding-top:10px;">{$events.newPosts}</td></tr>
                                        <tr><td style="{$sec_text_color}font-size: 11px">{_t("New replies")}</td></tr>
                                    </table>
                                </td>
                                <td width="100">
                                    <table cellpadding="0" border="0" cellspacing="0" style="text-align: center;{$table_style}">
                                        <tr><td style="font-size: 32px;font-weight: bold;padding-bottom: 8px;padding-top:10px;">{$events.newTopics}</td></tr>
                                                    ...
                                                    <tr>
                                                        <td style="padding-left: 6px;padding-bottom: 6px;">
                                                            ...
                                                            <table cellpadding="0" border="0" cellspacing="0" style="{$table_style}" >
                                                                ...
                                                                <tr>
                                                                    {*<td style="color:#777;font-size: 10px;">{$mention.actor.role}</td>*}
                                                                    <td style="{$sec_text_color}font-size: 11px;width: 50px;">{$reply.time.hour}:{$reply.time.minute} {$reply.time.meridiem}</td>
                                                                </tr>
                                                            </table>
                                                        </td>       
                                                    </tr>
                                                        ...
                                                        <td style="padding-left: 6px;padding-bottom: 6px;">
                                                            ...
                                                            <table cellpadding="0" border="0" cellspacing="0" style="{$table_style}" >
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="15"></td>
                                                                    <td width="400" style="color:#777">
                                                                        {if isset($topic.meta.new_topic_pid) && $topic.meta.new_topic_pid eq $reply.pid}
