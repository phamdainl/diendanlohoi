...
class ImportWorker {
    ...
    public function connect_db() {
        ...
        if ($this->importer == 'VBulletin') {
            $dir = $this->customData['vbulletin_attachments_dir'];
            $this->fetch->attachmentDir = rtrim($dir, '/') . '/';
        }
    ...
    public function import_posts()
    {
        ...
        if ($this->importer == 'VBulletin') {
            \DB::table(PREFIX . 'codo_import_data')->delete();
        }
        ...
        if ($this->importer == 'VBulletin') {
            ...
            $cron->set('import_bulk_data', "monthly");
        }
    }
