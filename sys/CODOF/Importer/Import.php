...
class Import
{
    ...
    public function empty_tables($what)
    {
        ...
        switch ($what) {
            ...
            case 'posts' :
                ...
                $qry[] = 'TRUNCATE TABLE codo_attachments';
                break;
    ...
    public function ins_posts($post_info, $offset = 0)
    {
        ...
        foreach ($post_info as $post) {
            ...
            if (isset($post['imessage']) && isset($post['omessage'])) {
                ...
                $posts[$i]["omessage"] = $html->filter(Format::parseBBCode(Format::nl2p($post['message'])), false, true);
            }
    ...
    public function ins_users($user_info)
    {
        ...
        $preprocessUsers = method_exists($this->driver, 'preprocess_user');
        ...
        foreach ($user_info as $user) {
            ...
            if ($preprocessUsers) {
                $this->driver->preprocess_user($user);
            }
